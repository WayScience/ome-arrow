...
Preliminary results in [ome-arrow-benchmarks](https://github.com/WayScience/ome-arrow-benchmarks) show that outcomes are highly workload- and layout-dependent. These benchmarks provide important insights into the performance tradeoffs of different OME Arrow layouts and access patterns.
